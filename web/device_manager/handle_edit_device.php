<?php
    ...
    if ($_POST["new_device_id"] == "new") {
        $sql_query="INSERT INTO devices(mac_address,resource_id,orientation,device_type,plugin,is_production,width,height,notes) VALUES (\"$mac\",\"$_POST[new_resource_id]\",$_POST[new_orientation],$_POST[new_device_type],$_POST[new_plugin],$_POST[new_production],$_POST[new_width],$_POST[new_height],\"$_POST[new_notes]\")";
    } else {
