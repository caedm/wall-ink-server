...
This function will gather data from your scheduling software and format it in a specific manner that will be used to generate images that a wall-ink device can display.  The schedule returned from your getSchedule() function will be passed into the scheduleGetImage() function to automatically create images as seen below.
